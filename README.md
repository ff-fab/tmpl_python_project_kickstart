...
| -------------------- | ------ | -------------------------------------------- | ---------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| `project_name`       | `str`  | _none_                                       | free text                                                  | The name of the project used across generated metadata and docs.                                    |
| `repo_name`          | `str`  | `project_name \| lower \| replace(' ', '-')` | free text                                                  | GitHub repository name used for repository URLs and references.                                     |
| `gh_token`           | `str`  | `""`                                         | free text                                                  | Optional GitHub token for local development integrations.                                           |
| `context7_api_key`   | `str`  | `""`                                         | free text                                                  | Optional Context7 API key for local development integrations.                                       |
| `module_name`        | `str`  | `project_name \| lower \| replace(' ', '_')` | free text                                                  | Name of the first Python package under `packages/src/<module_name>/`.                               |
| `description`        | `str`  | _none_                                       | free text                                                  | Short project description used in generated README and package metadata.                            |
| `license`            | `str`  | `MIT`                                        | `MIT`, `None`                                              | Controls license file rendering and the `codecov` prompt condition.                                 |
| `codecov`            | `bool` | `license != 'None'`                          | `true`, `false`                                            | Includes Codecov integration; prompt appears only when `license != 'None'`.                         |
| `coverage_threshold` | `int`  | `80`                                         | any integer (0 to disable)                                 | Minimum line coverage percentage to pass quality gates (`0` disables).                              |
| `robot_framework`    | `bool` | `false`                                      | `true`, `false`                                            | Includes Robot Framework integration testing support and related CI/test behaviors.                 |
| `docs_style`         | `str`  | `dita`                                       | `diataxis`, `dita`, `user-journey`, `architecture`, `flat` | Selects the documentation style guidance used in generated docs configuration/instructions.         |
| `release_please`     | `bool` | `true`                                       | `true`, `false`                                            | Adds Release Please automation for changelog, version bumps, and SemVer tags.                       |
| `init_git_on_copy`   | `bool` | `true`                                       | `true`, `false`                                            | Runs scaffold-time `_tasks` git init logic on `copier copy` (`git init -b main` fallback included). |
